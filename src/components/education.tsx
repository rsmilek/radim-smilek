...
const Education: FunctionComponent = () => {
  return (
    <div className="container" id="education">
      ...
      <div className="article-paragraph italic">
        Electronics and telecommunications technology, Measurement and automation technology
      </div>
      <div className="article-paragraph">
        Diploma thesis - Automated monitoring of frames and signaling of 2Mbit/s flows in telecommunications - creation
        of an application for data collection and analysis in LabVIEW including device drivers for GPIB bus (call
        analyzer Gm EPC91 and flow multiplexer Tesla MLT293)
      </div>
      ...
      <div className="article-paragraph">
        Graduation project - electronic potentiometer for audio signal level control with visualization of settings with
        the help of LED
      </div>
    </div>
  );
